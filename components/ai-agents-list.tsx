...
export function AIAgentsList() {
  const agents = [
    { id: 1, name: "Customer Support Bot", messages: 2400, users: 1200 },
    { id: 2, name: "Sales Assistant", messages: 1800, users: 900 },
    { id: 3, name: "Product Recommender", messages: 3200, users: 1600 },
  ]
